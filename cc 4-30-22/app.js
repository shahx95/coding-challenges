...
P: we will be expecting a string as an input. the string may be having letters different of both upper and lower case. we may get  non string value and will have to deal with such an input  
R: we will be returning a string according to the rules in the table above
E: 
